...
- normalize.css is a fancy way of doing

- still add this in your css
...
- setup basic return
- starting from react v17 we do not need to import React explicitly in our app
...
- Is preferred to keep styles along with components (In every component the styles exists inside the components)
...
The \* is a catch all for all routes that do not match
...
```js
appContext.js;
//note functions use objects as parameters that way you do not have to worry about the order of arguments
